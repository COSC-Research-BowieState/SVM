...
# -*- coding: utf-8 -*-
"""
Created on Thu Nov  1 23:36:46 2018
...
pi = m.pi
    ...
    def geenratePower(lambda1, lambda2):
        tic.clock()
    ...
    def scorePower(totalPwr):
        

    def total:
        lambda1 =1;
        lambda2 = 1;
        for i in np.arange(0,lambda1,0.0001):
            for j in np.arange(0,lambda2,0.0001):
                totalPwr = generatePower(i,j)